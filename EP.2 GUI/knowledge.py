...
GUI.title('โปรแกรมบันทึกข้อมูล')#นี่คือชื่อของบโปรแกรม
...
B2 = ttk.Button(FB1,text='เงินมีอยู่กี่บาท',command=Button2)#B2.pack(ipadx=20,ipady=20)
...
B3 = ttk.Button(FB1,text='สับดาห์นี้เรียนวิชาอะไร',command=Button3)#B2.pack(ipadx=20,ipady=20)
